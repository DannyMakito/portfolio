  ...
  return (
    <div
      ...
      <div ref={ref} className="relative pb-20">
        {data.map((item) => (
          <div key={item.date + item.job} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div
                className="h-10 absolute -left-[15px] w-10 rounded-full  bg-midnight flex items-center justify-center">
                <div
                  className="h-4 w-4 rounded-full bg dark:bg-neutral-800 border  dark:border-neutral-700 " />
              </div>
