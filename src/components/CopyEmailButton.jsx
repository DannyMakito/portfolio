...
const CopyEmailButton = () => {
    ...
    const email = "makitoeyamba@gmail.com";
  ...
  return (
    <motion.button className="relative px-1 py-4 text-sm text-center rounded-full font-extralight bg-primary w-[12rem] cursor-pointer
    overflow-hidden"  onClick={copyToClipBoard}
    whileHover={{y:-5}}
    whileTap={{scale:1.05}}>
